...
export function Menu() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col side-menu fixed top-0 w-[350px] h-full bg-[#1a1a1a] border-r rounded-r-3xl border-[#6a0dad] z-sidebar shadow-xl shadow-[#6a0dad] text-sm"
    >
          ...
          <DialogRoot open={dialogContent !== null}>
            ...
            <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
              {dialogContent?.type === 'delete' && (
                <>
                  <DialogTitle className="text-[#e1e1e1]">Delete Chat?</DialogTitle>
                  ...
                  <div className="px-5 pb-4 bg-[#1a1a1a] flex gap-2 justify-end">
